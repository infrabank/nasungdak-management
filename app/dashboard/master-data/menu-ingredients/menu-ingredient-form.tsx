                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select
                        ...
                        disabled={!!mapping}
                        className="mt-1 block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed"
                      >
