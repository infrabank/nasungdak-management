...
export default function MasterDataLoading() {
  return (
    <div className="animate-pulse">
      {/* Page Header */}
      <div className="mb-6">
        <div className="h-8 w-40 bg-brutal-black/10 border-2 border-brutal-black/20" />
        <div className="mt-2 h-4 w-64 bg-brutal-black/10 border-2 border-brutal-black/20" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          ...
          >
            {/* Card Header */}
            <div className={`${item.color} border-b-2 border-brutal-black/30 p-4`}>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-brutal-black/10 border-2 border-brutal-black/20" />
                <div className="h-5 w-24 bg-brutal-black/10" />
              </div>
            </div>
            {/* Card Body */}
            <div className="p-4">
              <div className="h-4 w-full bg-brutal-black/10 mb-2" />
              <div className="h-4 w-3/4 bg-brutal-black/10" />
            </div>
            {/* Card Footer */}
            <div className="px-4 py-3 border-t border-brutal-black/10">
