    ...
    <div className="pb-24 md:pb-0">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="hidden sm:flex sm:gap-3">
          ...
          <Link
            href={newPurchaseUrl}
            className="block border-2 border-brutal-black bg-brutal-yellow px-4 py-2 text-center text-sm font-bold text-brutal-black shadow-brutal transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-brutal-hover active:translate-x-0.5 active:translate-y-0.5 active:shadow-brutal-sm"
          >
            새 매입 등록
          </Link>
        </div>
        ...
        <div className="mt-4 flex items-center justify-between border-t-2 border-brutal-black/20 pt-4">
          ...
          <div className="flex gap-2">
            <a
              href={
                storeId
                  ? `/dashboard/purchases?storeId=${storeId}`
                  : '/dashboard/purchases'
              }
      ...
      <div className="mt-4 md:hidden">
        {purchases.length === 0 ? (
          <div className="border-3 border-brutal-black bg-brutal-white p-8 text-center shadow-brutal">
            ...
            <Link
              href={newPurchaseUrl}
              className="mt-4 inline-block px-1 font-bold text-brutal-black underline underline-offset-4 hover:bg-brutal-yellow"
            >
              새 매입 등록하기 →
            </Link>
          </div>
      ...
      <div className="fixed bottom-14 left-0 right-0 z-20 border-t-3 border-brutal-black bg-brutal-yellow p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] lg:hidden">
        <div className="flex gap-3">
          ...
          <Link
            href={newPurchaseUrl}
            className="flex-1 border-3 border-brutal-black bg-brutal-white py-3 text-center text-base font-bold text-brutal-black shadow-brutal transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-brutal-hover active:translate-x-0.5 active:translate-y-0.5 active:shadow-brutal-sm"
          >
            + 새 매입 등록
          </Link>
        </div>
